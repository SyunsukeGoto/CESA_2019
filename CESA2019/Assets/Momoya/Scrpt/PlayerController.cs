...
namespace Momoya
{
    public class PlayerController : MonoBehaviour
    {
        ...
        public enum PlayerMoveStaet
        {
            HAMMER_MOVE_STATE = (1 << 0),
        }
        ...
        void ChargeHammerPower()
        {
            ...
            if (Input.GetKey(_strikeKey))
            {
                ...
                if(!_playerFlag.IsFlag((uint)PlayerMoveStaet.HAMMER_MOVE_STATE))
                {
                    _playerFlag.OnFlag((uint)PlayerMoveStaet.HAMMER_MOVE_STATE);
                }
            }
        ...
        public void PlayerCtrl()
        {
            ...
            //速度を足す
            _rg.velocity = new Vector3(_vec.x * _environmentSpeed, this._rg.velocity.y, _vec.z * _environmentSpeed);
        ...
        public void Strike()
        {
            ...
            if (Input.GetKeyUp(_strikeKey))
            {
                ...
                _playerFlag.OffFlag((uint)PlayerMoveStaet.HAMMER_MOVE_STATE);
            }
        ...
        public Goto.Flag GetPlayerMoveStaet()
        {
            return _playerFlag;
        }
